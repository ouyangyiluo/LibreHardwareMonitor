...
namespace LibreHardwareMonitor.Hardware.Memory
{
    internal class Spd5Hub
    {
        ...
        Spd5Hub(SMBusDevice slave, byte hid, SPD5DeviceType deviceType) {
            ...
            //_i2cAddress = MakeI2cAddress(hid);

            //slave = new SMBusDevice(addr, smb_addr)
        }

        private byte MakeI2cAddress(byte hid)
        {
            return (byte)(hid & 0b1010000);
        }
        ...
        //        {
        //            //MR0 MR1  
        //            ushort deviceType = GetWord(addr, 0x00);
        //            if (deviceType != 0x1851)
        //            {
        //                return 0x00;
        //            }
        //        }
        ...
        //        {
        //            //MR3 MR4 
        //            ushort register = GetWord(addr, 0x03); //40326
        //            if (!spd5118_vendor_valid(register))
        //            {
        //                return 0x00;
        //            }
        //            //short vendorID = (short)((ushort)((register >> 8) | (((register & 0xFF) << 8)))); 
        //            //if (vendorID < 0)
        //            //{
        //            //    return 0x00;
        //            //}
        ...
        //        {
        //            //MR5 
        //            ushort register = GetWord(addr, 0x05);
        //            bool supportsTemperatureSensor = (register & 0x02) != 0;
        //            if (!supportsTemperatureSensor)
        //            {
        //                return 0x00;
        //            }
        //        }
        ...
        public float GetTemperature()
        {
            ...
            float temperature = SignExtend32(data >> 2, 10) * 0.25f;
        ...
        private bool Eeprom_SetPage(byte addressPagePointer)
        {
            ...
            if ((addressPagePointer & 0x08) != 0x00) // 0 = 1 Byte Addressing for SPD5 Hub Device Memory
            {
                return false;
            }
        ...
        private byte Eeprom_ReadByte(ushort eepromAddress)
        {
            ...
            offset |= 0x80; // set MemReg=1

            return _slave.ReadByte(offset);
        }

        //private ushort Eeprom_ReadWord(ushort eepromAddress)
        //{
        //    byte offset = (byte)(eepromAddress & 0x7F);
        //    if (offset >= 127)
        //    {
        ...
        //    byte ModuleOrganization = Eeprom_ReadByte(0x0EA);
        //    byte RankMix = (byte)((ModuleOrganization >> 6) & 0x01);
        //    byte NumberOfPackageRanksPerSubChannel = (byte)((ModuleOrganization >> 3) & 0x07);


        //    byte MemoryChannelBusWidth = Eeprom_ReadByte(0x0EB);
        //    byte PrimaryBuswidthPerSubChannelInBits = (byte)((ModuleOrganization >> 0) & 0x07);
        //    byte BusWidthExtensionPerSubChannelInBits = (byte)((ModuleOrganization >> 3) & 0x03);
        //    byte NumberOfSubChannelsPerDIMM = (byte)((ModuleOrganization >> 5) & 0x07);
